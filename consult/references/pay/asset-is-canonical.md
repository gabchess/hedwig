...
canonical deployment addresses, keyed by chain and symbol. This prevents an
agent from moving funds through a fake or copy-cat token contract that
reuses a real symbol such as "USDC" on the same chain.
